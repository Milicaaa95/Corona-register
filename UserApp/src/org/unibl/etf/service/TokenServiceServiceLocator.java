...
public class TokenServiceServiceLocator extends org.apache.axis.client.Service implements org.unibl.etf.service.TokenServiceService {
    ...
    private java.lang.String TokenService_address = "http://localhost:8080/TokenServerApp/services/TokenService";
    ...
    public org.unibl.etf.service.TokenService getTokenService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.unibl.etf.service.TokenServiceSoapBindingStub _stub = new org.unibl.etf.service.TokenServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.unibl.etf.service.TokenService.class.isAssignableFrom(serviceEndpointInterface)) {
                org.unibl.etf.service.TokenServiceSoapBindingStub _stub = new org.unibl.etf.service.TokenServiceSoapBindingStub(new java.net.URL(TokenService_address), this);
                _stub.setPortName(getTokenServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.etf.unibl.org", "TokenServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.etf.unibl.org", "TokenService"));
        }
